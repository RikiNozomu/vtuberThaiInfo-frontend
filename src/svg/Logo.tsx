export const Logo = (props: { className?: string }) => {
  return (
    ...
    >
      <g id="Folder 1">
        <path id="Shape 1 copy 2" className="s0" d="m0 0h290.7v1269h-290.7z" />
        <path
          id="Shape 1 copy 3"
          className="s0"
          d="m876 240h290.7v1029h-290.7z"
        />
        <path id="Shape 1 copy" className="s0" d="m584.1 81l18-36h987v36z" />
        <path
          id="Shape 1 copy 9"
          className="s0"
        ...
        <path
          id="Shape 1 copy 8"
          className="s0"
          d="m501.6 249l17.9-36h1069.6v36z"
        />
        <path
          id="Shape 1 copy 4"
          className="s0"
        ...
        <path
          id="Shape 1 copy 5"
          className="s0"
          d="m474.9 303.7h290.9l-474.9 965.3h-290.9z"
        />
      </g>
    </svg>
  );
